...
(function (modules) {
  // 缓存模块
  var installedModules = {}; // 在浏览器实现一套common.js require方法
  ...
  function require(moduleId) {
    ...
    var module = installedModules[moduleId] = {
      i: moduleId,
      // identify 模块ID 模块的标识符
      l: false,
      // loaded 资源是否已经加载成功或者初始化成功
      exports: {} // 当前模块的导出对象
  ...
  require.m = modules;
  require.c = installedModules; // 为了兼容导出，定义getter函数
  ...
  */
  ...
  "./src/title.js": function srcTitleJs(modules, exports) {
